...
import { parseWorktreeCreateRequest } from "../../../utils/worktree-request";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      statusCode: 500,
      statusMessage: `Git created the worktree at ${worktree.path}, but Atlas could not scan and open it.${detail}`,
    });
  }
